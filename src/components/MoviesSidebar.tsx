...
function MoviePreview({ movie }: { movie: Movie }) {
  return (
    <li
      className=" relative left-0 top-0 rounded-sm w-60 h-36 mb-8 cursor-pointer group"
      style={{
    ...
    >
      <div className="transition-opacity absolute left-0 top-0 flex flex-col justify-end items-center pb-4 w-60 h-36 text-white rounded-sm group-hover:opacity-0 opacity-100 ">
      ...
      <div className="transition-opacity absolute left-0 top-0 flex flex-col justify-end items-center pb-4 w-60 h-36 text-white rounded-sm cursor-pointer opacity-0 group-hover:opacity-100 p-6 bg-[#24242478]">
